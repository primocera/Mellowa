...
/**
 * Branded social card (Launch v6, Prompt 23), 1200×630. Rendered at build/edge
 * with next/og so it needs no binary asset in the repo. Copy is the real
 * product promise — no fabricated stats or testimonials.
 */
